...
try {
  ...
  assert.strictEqual(
    hash1,
    hash2,
    'Hashes for objects with same keys/values should match',
  );
  assert.notStrictEqual(
    hash1,
    hash3,
    'Object and array should produce different hashes',
  );
  assert.notStrictEqual(
    hash4,
    hash5,
    'String and number should produce different hashes',
  );
