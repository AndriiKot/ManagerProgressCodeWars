...
import { SaveAuthoredResponse } from './SaveAuthoredResponse.js';

// ====== OK RESPONSE ======
const okResponse = SaveAuthoredResponse.ok(
  { challenges: ['a', 'b'] },
  2, // savedCount
  3  // total
);
...
// ====== FAIL RESPONSE ======
const failResponse = SaveAuthoredResponse.fail(
  { challenges: ['a', 'b'] },
...
assert.deepStrictEqual(failResponse.errors, [{ id: 'xyz', error: 'Not found' }]);
