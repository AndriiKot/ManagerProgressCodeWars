...
test('codeChallengeSchema validates correct data', () => {
  const data = {
    ...
    createdBy: { username: "xDranik", url: "http://www.codewars.com/users/xDranik" },
    approvedBy: { username: "xDranik", url: "http://www.codewars.com/users/xDranik" },
    totalAttempts: 4911,
    totalCompleted: 919,
    totalStars: 12,
    voteScore: 512,
...
test('codeChallengeSchema fails with missing required fields', () => {
  ...
  assert.ok(result.errors.some(e => e.message.includes("Required field 'url' is missing")));
